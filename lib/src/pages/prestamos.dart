                    ...
                    return Card(
                      ...
                      child: ListTile(
                        ...
                        trailing: IconButton(
                          ...
                          onPressed: () =>
                              _confirmDeletePrestamo(context, prestamo['id']),
                        ),
                        onTap: () {
                          Navigator.push(
                            context,
  ...
  void _confirmDeletePrestamo(BuildContext context, String prestamoId) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content:
            const Text('¿Estás seguro de que deseas eliminar este préstamo?'),
        actions: [
          TextButton(
            onPressed: () {
          ...
          TextButton(
            onPressed: () {
              ...
              deletePrestamo(
                  prestamoId); // Llama a la función para eliminar el préstamo
            },
